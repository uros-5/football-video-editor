<template>
  <div class="columns is-centered is-multiline">
    <div class="column is-12 matchInfo-container">
      ...
      <h2 class="matchInfo__editing-response" v-if="isChosen == true">
        {{ editing }}
      </h2>
      <div
      ...
      <a
        class="matchInfo__title button is-success"
        @click="saveBtn"
        style="margin-top: 0.75em"
        >SAVE
        <div class="message-server" ref="messageServer">MatchInfo saved!</div>
      </a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    showMessage() {
      let elemAnim = gsap.to(this.$refs.messageServer, {
        duration: 0.3,
        scale: 1.0,
      });
      setTimeout(function () {
